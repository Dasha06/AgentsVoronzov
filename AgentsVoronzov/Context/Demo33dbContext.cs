...
namespace AgentsVoronzov.Context;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Agent>(entity =>
        {
            ...
            entity.ToTable("Agent", "Voronzov1");
        ...
        modelBuilder.Entity<AgentPriorityHistory>(entity =>
        {
            ...
            entity.ToTable("AgentPriorityHistory", "Voronzov1");
        ...
        modelBuilder.Entity<AgentType>(entity =>
        {
            ...
            entity.ToTable("AgentType", "Voronzov1");
        ...
        modelBuilder.Entity<Material>(entity =>
        {
            ...
            entity.ToTable("Material", "Voronzov1");
            ...
            entity.HasMany(d => d.Suppliers).WithMany(p => p.Materials)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.ToTable("MaterialSupplier", "Voronzov1");
        ...
        modelBuilder.Entity<MaterialCountHistory>(entity =>
        {
            ...
            entity.ToTable("MaterialCountHistory", "Voronzov1");
        ...
        modelBuilder.Entity<MaterialType>(entity =>
        {
            ...
            entity.ToTable("MaterialType", "Voronzov1");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.ToTable("Product", "Voronzov1");
        ...
        modelBuilder.Entity<ProductCostHistory>(entity =>
        {
            ...
            entity.ToTable("ProductCostHistory", "Voronzov1");
        ...
        modelBuilder.Entity<ProductMaterial>(entity =>
        {
            ...
            entity.ToTable("ProductMaterial", "Voronzov1");
        ...
        modelBuilder.Entity<ProductSale>(entity =>
        {
            ...
            entity.ToTable("ProductSale", "Voronzov1");
        ...
        modelBuilder.Entity<ProductType>(entity =>
        {
            ...
            entity.ToTable("ProductType", "Voronzov1");
        ...
        modelBuilder.Entity<Supplier>(entity =>
        {
            ...
            entity.ToTable("Supplier", "Voronzov1");
